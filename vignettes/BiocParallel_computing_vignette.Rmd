...
Because we will loop over each of the 11 region types, we set up the static data. If you would like to analyse all region types, use the first `regions_char` vector. For time, we will use a subset of regions near the islands.
```{r setup_for_loop}
