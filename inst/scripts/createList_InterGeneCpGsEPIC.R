...
### Find overlap between gene regions and intergenic regions
...
CpGgenesCloseBy <- readRDS("Gene_3_200EPIC.rds")
...
overlapDF<-as.data.frame(overlap)
interFix<-region3_200[-overlapDF$subjectHits]
saveRDS(interFix, "InterGene_3_200EPIC.rds")
...
saveRDS(regionNoXY, "InterGene_3_200EPICnoXY.rds")
